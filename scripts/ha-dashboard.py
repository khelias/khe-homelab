...
energy = {"title": "Energia", "path": "energia", "icon": "mdi:lightning-bolt", "type": "sections", "max_columns": 2, "sections": [
    ...
    section("Kui palju maja tarbib", [
        note("the grid operator tunnitarbimine, imporditud CSV-st. Uueneb ainult uue ekspordiga, praegu kuni 31.08. Kuu ja aasta summad on külgriba Energia töölaual."),
